...
knitr::include_graphics(
            c("https://www.commonwl.org/CWL-Logo-Header.png",
...
| Turning your script into a command line tool | Marko Zecevic  | 20m  |
...
CWL can be written in easily readable and parsable YAML, or a bit less readable, but just as parsable JSON - or a combination of both! There’s an increasing number of extensions and tooling that facilitate code development, testing, and execution. One such set of tools is the [Rabix project](Rabix.io) from Seven Bridges - an open-source project that enables rapid composition and execution of CWL workflows in a manner that is scalable and reproducible.

CWL requires executors or workflow engines to interpret and execute. Later on you will learn how to run CWL tools using SystemPipeR R package.
...
<center>
`r knitr::include_graphics(file.path(system.file(package='BioC19CWL', 'vignettes', "images"), "pipeline.png"))`
</center>
...
CWL is modular in nature: a CWL workflow consists of multiple steps which are nothing other than individual CWL tool descriptions linked together. These CWL tools are reusable and can be simply added to a new workflow every time you need them in your analysis. Because of this, tool developers are encouraged to wrap their tools into CWL and share these wrappers publicly, thus enabling scientists (and enthusiasts alike) to include them in their data analysis pipelines as easy as a simple drag and drop in a convenient GUI CWL editor (such as [Rabix Composer](https://github.com/rabix/composer)).

<center>
`r knitr::include_graphics("https://github.com/rabix/composer/raw/master/doc/images/workflows.gif")`
</center>

<div align="center">**Figure 11:** Creating CWL workflow with Rabix Composer. </div></br>
